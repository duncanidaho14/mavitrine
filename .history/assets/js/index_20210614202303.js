...
window.addEventListener('scroll', () => {
    ...
    if (window.scrollY > 650) {
        ...
        for (let i = 0; i < determinate.length; i++) {
            ...
            setTimeout(() => {
                symfony.style.backgroundColor = '#000000';
                progressbar.style.height = '20px';
                progressbar.style.paddingTop = '20px';
                progressbar.style.color = 'withe';
                progressbar.style.width = element.getAttribute('data-done') + '% ';
